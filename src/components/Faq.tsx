...
const FAQS: [string, string][] = [
  ...
  ['Karyawan saya gaptek, bisa nggak ya?', 'Bisa. Tampilannya cuma ketuk menu → bayar → selesai. Ada contoh menu siap pakai dan panduan di dalam aplikasi — kasir baru biasanya lancar di hari pertama.'],
  ['Kalau HP rusak atau hilang, data ikut hilang?', 'Di iPOS Offline ada tombol backup satu ketuk ke file — simpan di Google Drive kamu. Di paket cloud, data tersimpan di server, jadi ganti HP tinggal login.'],
