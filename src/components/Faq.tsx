...
// Dikelompokkan per tema (bukan 10 item flat) supaya lebih cepat di-scan.
...
export function Faq() {
  return (
    <RevealGroup className="space-y-8" stagger={0.05}>
      {FAQ_GROUPS.map((group) => (
        <div key={group.title}>
          <p className="text-sm font-bold text-charcoal mb-3">{group.title}</p>
