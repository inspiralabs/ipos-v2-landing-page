      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          <a href={kontakLink('Halo Inspira POS, saya ingin bertanya.')} target="_blank" rel="noreferrer"
            className="card-brand p-6 text-left">
          ...
          <a href={`mailto:${CONTACT.email}`} className="card-brand p-6 text-left">
          ...
          <a href={CONTACT.website} target="_blank" rel="noreferrer" className="card-brand p-6 text-left">
